...
class setting_config:
    ...
    model_config = {
        ...
        'drop_path_rate': 0.3, 
        'load_ckpt_path': '/mnt/d/graduate/VM-UNetV2-main/VM-UNetV2-main/pre_trained_weights/vmamba_small_e238_ema.pth',
    ...
    if datasets == 'isic18':
        ...
        data_path = '/mnt/d/graduate/VM-UNetV2-main/VM-UNetV2-main/data/isic2017/'
    elif datasets == 'polyp':
    ...
    elif datasets == 'uwf-rhs':
        data_path = '/mnt/d/graduate/VM-UNetV2-main/VM-UNetV2-main/data/uwf-rhs/'
    else:
        raise Exception('datasets in not right!')

    criterion = BceDiceLoss(wb=0.4, wd=0.6)
    ...
    work_dir = '/mnt/d/graduate/VM-UNetV2-main/VM-UNetV2-main/results/' + network + '_' + datasets + '_' + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'

    print_interval = 140
    val_interval = 1
    save_interval = 1
    threshold = 0.5
    early_stopping = 20  # 连续20轮没有改善就停止
    early_stopping_delta = 1e-4  # 最小改善阈值
