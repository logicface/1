...
class setting_config:
    ...
    model_config = {
        ...
        'drop_path_rate': 0.2,
        # 'load_ckpt_path': '/mnt/d/graduate/VM-UNet-main/pretrained_weights/vmamba_small_e238_ema.pth',
    }

    datasets = 'uwf-rhs' 
    if datasets == 'uwf-rhs':
        data_path = '/mnt/d/graduate/VM-UNet-main/data/uwf-rhs/'
        # testdata_path = 'd/graduate/VM-UNet-main/data/uwf-rhs/test/'
    elif datasets == 'isic17':
        data_path = '/mnt/d/graduate/VM-UNet-main/data/isic2017/'
    else:
    ...
    work_dir = '/mnt/d/graduate/VM-UNet-main/results/' + network + '_' + datasets + '_' + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
